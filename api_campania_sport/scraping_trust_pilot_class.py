...
from api_campania_sport.models import ScrapingReviewsWords, ScrapingReviewsUrls


def scraping_trust_pilot():
    prodotti_da_cercare = words.splitlines()
    ...
    for idx, i in enumerate(prodotti_da_cercare):
        ...
        try:
            ...
            if n_parola > 200:  # arrivati a 100 mila link ci fermiano
                print("finito!!!!")
                break
            else:
                # inseriamo la parola nella tabella delle parole già cercate
                found_word = ScrapingReviewsWords(word=i)
                found_word.save()
                ...
                url = "https://it.trustpilot.com/search?experiment=c&query=" + i
                headers = {
                ...
                for link in soup.findAll("a"):
                    if str(link.get("href")).startswith("/review"):
                        print(url)
                        url="https://it.trustpilot.com"+link.get("href")

                        new_url = ScrapingReviewsUrls(url=url)
                        new_url.save()
